...
Language: All code must be Clojure (JVM), compatible with JDK 17 LTS 

5. Role Policy Locations (Convention)
...
Architect: agents/Architect/AGENTS-ROLE.md
Senior Engineer: agents/SeniorEngineer/AGENTS-ROLE.md
